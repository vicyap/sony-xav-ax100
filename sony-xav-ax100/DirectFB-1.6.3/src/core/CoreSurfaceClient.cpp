...
)
{
    ...
    ret = (DFBResult) CoreSurfaceClient_Call( obj, (FusionCallExecFlags)(FCEF_ONEWAY), CoreSurfaceClient_FrameAck, args, sizeof(CoreSurfaceClientFrameAck), NULL, 0, NULL );
    if (ret) {
