...
#define DRIVER_DESC		"letb8700-CARDVD-658-DEV-V14"//"letb8700_Android"
#define IAP
//#define HOT_PLUG
...
{	
	...
	IAP_DEBUG("%s %d len=%d \n", __FUNCTION__,__LINE__,iap_rx[read_index].len);
#if 1
...
int  iap_task_handle(void * data)
{
	while(1){
		...
		printk("create = %d condition=%d\n",ep_iap_out->driver_data?1:0,my_iap_dev.main_condition);
