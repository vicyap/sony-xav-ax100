...
static struct usb_endpoint_descriptor fsg_fs_intr_in_desc = {
	.bLength = USB_DT_ENDPOINT_SIZE,
	.bDescriptorType = USB_DT_ENDPOINT,
...
static __maybe_unused struct usb_endpoint_descriptor *fsg_ep_desc(struct
								  usb_gadget *g,
								  struct
