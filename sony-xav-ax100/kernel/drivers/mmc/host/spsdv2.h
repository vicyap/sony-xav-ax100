...
#define SP_DMA_TYPE_MULTIBLOCK_CMD		2
	...
	dv_reg sdfreq:2;				//high 2 bits of sd frequency
...
#define	HWSD_SM_RST_CHAN_TIMEOUT	0x53
	...
	dv_reg sdrxdattmr_sel:2;		//14.
	dv_reg sd_clk_dly_sel:3;
	dv_reg reserved_sd_clk_dly:27;
...
//	dv_reg reserved_reserved_4_29[3];	//29.
} SDREG;
