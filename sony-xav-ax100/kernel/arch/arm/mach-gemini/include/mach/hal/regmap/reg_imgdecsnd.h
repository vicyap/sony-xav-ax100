#ifndef __REG_IMGDECSND_H__
#define __REG_IMGDECSND_H__
...
#define IMG_DEC_HUF_SND_GRP					137
#define IMG_DEC_HUF_SND_BASE					IO0_ADDRESS(IMG_DEC_HUF_SND_GRP*32*4)
#define LOGI_ADDR_IMG_DEC_SND_HUF_REG		(IMG_DEC_HUF_SND_BASE)
...
#define RGST_IMG_DEC_SND_SIZE 					0x180 			// HW register physical memory size for IMG_DEC_SND (3x128)
#define RGST_IMG_DEC_SND_HUF_OFFSET 			137*128 			// IMG_DEC_SND/HUF HW reg address offset G137 (0x4480)
#define RGST_IMG_DEC_SND_JDM_OFFSET 			138*128 			// IMG_DEC_SND/JDM HW reg address offset G138 (0x4500)
#define RGST_IMG_DEC_SND_JPG_INVQ_OFFSET 	139*128 			// IMG_DEC_SND/JPG_INVQ HW reg address offset G139 (0x4580)
...
typedef struct _IMG_DEC_SND_REG_
{
