...
#ifndef __IMGDEC_HAL_H__
#define __IMGDEC_HAL_H__

#include <linux/types.h>
#include <linux/module.h>
#include <mach/common.h>
#include <mach/hal/regmap/reg_system.h>
#include <mach/hal/regmap/reg_imgdec.h>
#include <mach/imgdec.h>
...
#define PNG_JR_PIPELINE_ENABLE		1
...
//PNG critical chunk types:
#define PNG_CHUNK_IHDR		0x49484452 //73 72 68 82  IHDR
#define PNG_CHUNK_PLTE		0x504C5445 //80 76 84 69 PLTE
#define PNG_CHUNK_IDAT		0x49444154 //73 68 65 84 IDAT
#define PNG_CHUNK_IEND		0x49454E44 //73 69 78 68 IEND

//PNG ancillary chunk types:
#define PNG_CHUNK_tRNS		0x74524E53 //116 82 78 83 tRNS
#define PNG_CHUNK_cHRM		0x6348524D //99 72 82 77 cHRM
#define PNG_CHUNK_gAMA	0x67414D41 //103 65 77 65 gAMA
#define PNG_CHUNK_iCCP		0x69434350 //105 67 67 80 iCCP
#define PNG_CHUNK_sBIT		0x73424954 //115 66 73 84 sBIT
#define PNG_CHUNK_sRGB		0x73524742 //115 82 71 66 sRGB
#define PNG_CHUNK_tEXt		0x74455874 //116 69 88 116 tEXt
#define PNG_CHUNK_iTXt		0x69545874 //105 84 88 116 iTXt
#define PNG_CHUNK_zTXt		0x7A545874 //122 84 88 116 zTXt
#define PNG_CHUNK_bKGD		0x624B4744 //98 75 71 68 bKGD
#define PNG_CHUNK_hIST		0x68495354 //104 73 83 84 hIST
#define PNG_CHUNK_oFFs		0x6F464673 //111 70 70 115 oFFs
#define PNG_CHUNK_pCAL		0x7043414C //112 67 65 76 pCAL
#define PNG_CHUNK_sCAL		0x7343414C //115 67 65 76 sCAL
#define PNG_CHUNK_pHYs		0x70485973 //112 72 89 115 pHYs
#define PNG_CHUNK_sPLT		0x73504C54 //115 80 76 84 sPLT
#define PNG_CHUNK_tIME		0x74494D45 //116 73 77 69 tIME

#define PNG_GRAYSCALE_IMAGE			0
#define PNG_RGB_IMAGE					2
#define PNG_RGB_INDEX_IMAGE			3
#define PNG_GRAYSCALE_ALPHA_IMAGE	4
#define PNG_RGB_ALPHA_IMAGE			6
...
int imgdec_hal_reg_mmap(void);
void imgdec_hal_reg_unmmap(void);
void imgdec_hal_print_all_registers(void);
int imgdec_hal_data_ram_mmap(void);
void imgdec_hal_data_ram_unmmap(void);
//---------------------------------------------------------------
...
void imgdec_hal_jpeg_fill_bs_tables(
	JPEG_INFO *jpeg_info_data);
void imgdec_hal_jpeg_init_MJmode_waitqueue_head(void); // MJmode uses interrupt to replace polling
