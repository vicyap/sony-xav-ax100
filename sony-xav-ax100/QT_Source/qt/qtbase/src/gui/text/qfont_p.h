...
struct QFontDef
{
    inline QFontDef()
        : pointSize(-1.0), pixelSize(-1),
          ...
          spStroke(false),spStrokeColor(0),spStrokeLineColor(0) //S+
    {
    }
    ...
    {
//S+
        bool result = pixelSize == other.pixelSize
                    && weight == other.weight
                    && style == other.style
        ...
        if (spStroke){
            result = result && (spStroke == other.spStroke) && (spStrokeColor == other.spStrokeColor) && (spStrokeLineColor == other.spStrokeLineColor);
        }else{
            result = result && (spStroke == other.spStroke);
        }
...
*/
    ...
    {
        //S+
        /*only compare stoke style when it is enabled, otherwise, discard it
          return true means there is a new style need to be initialized
        */
        if (spStroke || other.spStroke){
            if((spStroke != other.spStroke) || (spStrokeColor != other.spStrokeColor) ||  (spStrokeLineColor != other.spStrokeLineColor)) 
                return true;
        }else{
            if(spStroke != other.spStroke) return true;
        }
