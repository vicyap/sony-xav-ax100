...
public:
    ...
    enum Property {
        ...
        */
        ...
        //S+
        , SPFontStroke = (UserProperty + 1)
        , SPFontStrokeColor = (UserProperty + 2)
        , SPFontStrokeLineColor = (UserProperty + 3)        
    };
...
public:
    ...
    //S+
    inline void spSetFontStroke(int s)
    { setProperty(SPFontStroke, s); }
    inline uint spFontStroke() const
    { int s = intProperty(SPFontStroke); return s; }
    inline void spSetFontStrokeColor(int s)
    { setProperty(SPFontStrokeColor, s); }
    inline uint spFontStrokeColor() const
    { int s = intProperty(SPFontStrokeColor); return s; }
    inline void spSetFontStrokeLineColor(int s)
    { setProperty(SPFontStrokeLineColor, s); }
    inline int spFontStrokeLineColor() const
    { int s = intProperty(SPFontStrokeLineColor); return s; }
