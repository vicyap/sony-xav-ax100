...
public:
    ...
    enum ResolveProperties {
        ...
        //S+
        SpStrokeResolved            = 0x20000,
        SpStrokeColorResolved	    = 0x40000,
        SpStrokeLineColorResolved   = 0x80000,
    ...
    //S+
    bool spStroke() const;
    void spSetStroke(bool);
    uint spStrokeColor() const;
    void spSetStrokeColor(uint);
    uint spStrokeLineColor() const;
    void spSetStrokeLineColor(uint);
