...
{
	uint destFetch_ptr[buffer_size];
	...
	memcpy(destFetch_ptr,ptr,sizeof(uint)*length);
    return const_cast<uint *>(layout->convertToARGB32PM(buffer, destFetch_ptr, length, layout, 0));
}
