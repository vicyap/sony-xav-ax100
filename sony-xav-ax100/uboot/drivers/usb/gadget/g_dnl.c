...
#define CONFIG_G_DNL_PRODUCT_NUM	0xd002//0x8388
#define CONFIG_G_DNL_MANUFACTURER	"Sunplus"
...
static char g_dnl_serial[MAX_STRING_SERIAL] = "s+";
...
static struct usb_device_descriptor device_desc = {
	...
	.bcdUSB = __constant_cpu_to_le16(0x0200),//0x0200
	.bDeviceClass = 0,//USB_CLASS_COMM,
...
static int g_dnl_bind(struct usb_composite_dev *cdev)
{
	...
	device_desc.bcdDevice = __constant_cpu_to_le16(0x0232);
