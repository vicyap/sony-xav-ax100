...
INC_H=__INC_ECOS_MEM_H__

echo -e "// This file is generated automatically" > $OUT_H
echo -e "#ifndef $INC_H" >> $OUT_H
echo -e "#define $INC_H\n" >> $OUT_H

out_def_var CONFIG_SP_ECOS_RAM1_ADDR 1
out_def_var CONFIG_SP_ECOS_RAM1_SIZE 1
out_def_var CONFIG_SP_HW_BUF_ADDR 1
out_def_var CONFIG_SP_HW_BUF_SIZE 1
out_def_var CONFIG_SP_ECOS_RAM2_SIZE 1
out_def_var CONFIG_SP_ECOS_END_ADDR 1
