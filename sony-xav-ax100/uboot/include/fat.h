...
int fat_mkfs_ff(block_dev_desc_t *rbdd, disk_partition_t *info);
int fat_fdisk_ff(block_dev_desc_t *rbdd, disk_partition_t *info);
int fat_mkdir_ff(block_dev_desc_t *rbdd, disk_partition_t *info, const char *pathname);
