...
#if defined(CONFIG_ENV_IS_IN_SP_NAND)
# ifndef ENV_BLK_SCAN_START
#  error "Need to define ENV_BLK_SCAN_START when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef ENV_BLK_SCAN_END
#  error "Need to define ENV_BLK_SCAN_END when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef CONFIG_ENV_SIZE
#  error "Need to define CONFIG_ENV_SIZE when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef ENV_MAGICNUM
#  error "Need to define ENV_MAGICNUM when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef ENV_MAGICNUM_SIZE
#  error "Need to define ENV_MAGICNUM_SIZE when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef CONFIG_SP_ENV_SIZE
#  error "Need to define CONFIG_SP_ENV_SIZE when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
# ifndef ENV_PART_NAME
#  error "Need to define ENV_PART_NAME when using CONFIG_ENV_IS_IN_SP_NAND"
# endif
#endif /* CONFIG_ENV_IS_IN_SP_NAND */
...
typedef struct environment_s {
	...
	uint32_t	magicnum;	/* magic number for dynamically scanning for valid uboot env */
#endif
