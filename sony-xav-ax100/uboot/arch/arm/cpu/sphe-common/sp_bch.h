...
#define SR_ERR_BITS(x)		(((x) >> 8) & 0x7ff) //(((x) >> 5) & 0xfff)
#define SR_ERR_MAX(x)		(((x) >> 20) & 0x7f) //(((x) >> 17) & 0x3f)
#define SR_BLANK_00			BIT(28) //BIT(30) /* data are all 0x00 */
#define SR_BLANK_FF			BIT(29) //BIT(31) /* data are all 0xff */
