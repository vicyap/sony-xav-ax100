...
#else
/* Command "mmc start" is used to simplify gemini platform ISP's script
 * (since usb uses "usb start" for initialization)
 */
	if (strcmp(argv[1], "rescan") == 0 || strcmp(argv[1], "start") == 0 ) {
#endif
		struct mmc *mmc;
